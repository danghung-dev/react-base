...
const BASE_URL =
  "https://5eb1198d-cfe5-4845-a32f-8ffeb5cd9dc6.mock.pstmn.io/smartlog"
  ...
  if (needAuth) {
    if (accessToken) {
      ...
      return Promise.resolve(
        utils.returnErrorResponse("Access Token not found")
      )
    }
  }
...
export const getOrderList = () => {
  const url =
    "https://9b9d3312-761b-4082-b8a4-cd17a8318b2f.mock.pstmn.io/smartlog/orders"
  const options = {
    method: "GET",
    headers: { "Content-Type": "application/json" }
  }
